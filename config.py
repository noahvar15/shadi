...
class Settings(BaseSettings):
    model_config = SettingsConfigDict(env_file=[".env.demo", ".env"], extra="ignore")
    ...
    LLM_HTTP_TIMEOUT_SECONDS: float = 1800.0
    OLLAMA_EMBED_TIMEOUT_SECONDS: float = 180.0

    # arq job timeout — full pipeline can exceed 20 min with 70B models on a single GPU.
